...
class Config(object):
    ...
    def _init_train_config(self):
        ...
        self.train_file = os.path.join(self.base_path, 'data', 'mydata/my_train.txt')
        self.eval_file = os.path.join(self.base_path, 'data', 'mydata/my_first.txt')
        self.test_file = os.path.join(self.base_path, 'data', 'mydata/second.txt')
